...
export default function Form() {
  ...
  const validate = () => {
    ...
    if (!formData.phone || !isValidPhoneNumber(formData.phone)) newErrors.phone = "Valid phone required";
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const validationErrors = validate(); // Your client-side validation
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setFormData({
          firstName: '', lastName: '', company: '', email: '', phone: '', message: '', agree: false,
        });
      }
    } catch (error) {
    ...
    <div className="isolate bg-white px-6 pt-0 pb-24 sm:py-32 lg:px-8 relative">
      ...
      <div className="relative text-center py-20 sm:py-28">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          Tell us about your web, mobile, design, or marketing project. Our team is ready to collaborate.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <PhoneInput
                ...
                className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 placeholder:text-gray-400 outline-1 outline-gray-300 focus:outline-indigo-600"
              />
          ...
          {errors.agree && <p className="text-sm text-red-600 sm:col-span-2">{errors.agree}</p>}
        </div>
