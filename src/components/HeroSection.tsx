...
import Designimg from '../assets/Adobe Express - file.png';

const HeroSection = () => {        
    return (
    <div className="bg-gradient-to-b from-[#101212] relative to-[#08201D] font-Lato">
                ...
                <div className="flex items-center justify-between h-16 lg:h-20">
                    <div className="flex-shrink-0 gap-4">
                        <a href="#" title="" className="flex">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36" color="#ffff" fill="none">
                    ...
                    <div className="hidden lg:ml-8 lg:flex lg:items-center lg:justify-center lg:space-x-10">
    ...
    <motion.section initial={{ y: 100, opacity: 0}} animate={{ y:0, opacity: 1 }} transition={{ duration: 1 }} className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
        <div className="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
        <img className="hidden w-full lg:block" src={Designimg} alt="web-design" />
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div className="max-w-xl mx-auto text-center">
                <h1 className="text-4xl font-bold sm:text-6xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Digital innovative solutions </span>
                </h1>
                <p className="mt-5 text-base text-white sm:text-xl">Creative and Innovative web solutions for firms, and emergining businesses wanting to establish foundation</p>

                <a href="#" title="" className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-lime-500 rounded-lg sm:mt-16 hover:bg-lime-600 focus:bg-lime-600" role="button">
                    Apply for free
                ...
                <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div className="flex items-center">
                        ...
                        <p className="ml-3 text-sm text-white">Over 12+ projects completed</p>
                    </div>
